package com.matthewpoindexter.physics;
...
public class Bouncer extends Applet implements ActionListener,KeyListener{
	/**
	 * 
	 */
	...
	boolean space;
	Line2D obstacle = new Line2D.Double( new Point2D.Double(300, 400), new Point2D.Double(400, 250));
